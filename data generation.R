### This code read and process raw data from 1991-2017 separately with 
### 10 different csv files since the surveys are different.
### The code recodes some survey questions and keeps only 76 variables
### to maintain consistence.


setwd("NYCHVS Project/data")
...
### Delete 80 irrelavant variables.
f10[,137:216] <- NULL

### Select variables manually to keep consistence of the survey
...
### unify column names for further binding
...
write.csv(data,file="rawdata.csv",row.names = F)
